...
const BONUSES = [
  ...
  { n: 6, name: "Day 21 Celebration + Next Ritual", value: "$47", body: "When you complete Day 21, you unlock a celebration screen, your Glow Score, and a shareable card." },
];
        ...
        <div className="mt-6 space-y-4">
          {BONUSES.map((b, i) => (
            <div
              ...
              style={{ boxShadow: "0 2px 12px rgba(123, 45, 78, 0.08)" }}
            >
