...
export const RECIPES: Recipe[] = [
  { id: "pomegranate-elixir", name: "The Pomegranate Glow Elixir",
    gradient: "linear-gradient(135deg, #9B1B3A 0%, #7B2D4E 100%)",
  ...
  { id: "berry-bloom", name: "Berry Bloom",
    gradient: "linear-gradient(135deg, #7B2D4E 0%, #C49A6C 100%)",
  ...
  { id: "cherry-cacao", name: "Cherry Cacao",
    gradient: "linear-gradient(135deg, #6B1730 0%, #9B1B3A 100%)",
  ...
  { id: "plum-rose", name: "Plum & Rose",
    gradient: "linear-gradient(135deg, #C49A6C 0%, #9B1B3A 100%)",
  ...
  { id: "watermelon-reds", name: "Watermelon Reds",
    gradient: "linear-gradient(135deg, #9B1B3A 0%, #C49A6C 100%)",
  ...
  { id: "fig-almond", name: "Fig & Almond",
    gradient: "linear-gradient(135deg, #5C2541 0%, #C49A6C 100%)",
  ...
  { id: "beet-glow", name: "Beet Glow",
    gradient: "linear-gradient(135deg, #6B1730 0%, #C49A6C 100%)",
